...
let CategoriesController = class CategoriesController {
    ...
    async triggerScrape(categoryId) {
...
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('parentCategoryId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('navigation/:navigationHeadingId'),
    __param(0, (0, common_1.Param)('navigationHeadingId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "findByNavigationHeading", null);
__decorate([
    (0, common_1.Get)('tree'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CategoriesController.prototype, "triggerScrape", null);
